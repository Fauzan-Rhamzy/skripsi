...
// import LecturerTopicTableRow from "./components/CoordinatorTopicTableRow";
import LecturerTopicTableRow from "../../dosen/kelolaTopik/components/LecturerTopicTableRow";
...
function KoordinatorDashboardPage() {
  useEffect(() => {
...
export default KoordinatorDashboardPage;
